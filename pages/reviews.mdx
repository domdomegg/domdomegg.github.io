...
- You warrant the artefact is reviewable. This means:
  ...
  - You're not making significant changes to the artefact irregadless of my review, which would likely invalidate a review.
...
- If you have a fixed dealine, you say so at the start.
...
<br/><br/>Your attempt to unblock yourself should be proportionate to how long you think it would take me to unblock you: the two failure modes here are either:
