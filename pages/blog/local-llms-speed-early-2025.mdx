...
> **Update, April 2026**: I've re-run this a year on; see [Running LLMs Locally in 2026](../local-llms-speed-early-2026/).
...
Anything above this slows to a crawl and isn't that usable locally. These models also use up all your RAM, which freezes up your computer.
