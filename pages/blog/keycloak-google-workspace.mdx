...
If you already have a [Google Workspace](https://workspace.google.com/) account, you can set up a free SMTP relay in a few minutes. As well as saving you a separate SMTP service, you get all the benefits of your existing Google Workspace email setup, such as DKIM signing.
