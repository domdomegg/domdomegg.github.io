...
This was a section on my homepage, part of a [How to work with me manual](https://medium.com/swlh/user-manual-to-me-92c8ce68f960) / [User Guide](https://lg.substack.com/p/the-looking-glass-a-user-guide-to). I extracted it here to reduce clutter there, and make it easier to reference directly.
...
- **Prefer async communication (email, Slack, docs) over unplanned calls,** with clear action items and timelines.
...
- **I will send you asynchronous communications while sitting next to you,** unless you ask me not to. This avoids interrupting you, and lets you address comments at a time convenient to you.
