...
Reducing cycle time also tightens the feedback loop, so you can [self-improve](../thinking-tools-to-be-more-effective-at-anything/#recursively-self-improve) and react to [what users are telling you](../thinking-tools-to-be-more-effective-at-anything/#climb-the-user-contact-ladder) quicker.
