...
A lot of people ask me to review their work - code changes, strategic plans, AI safety papers, legal drafts, etc.!

This guide helps you get the most value out of that review.
...
- Mandatory feedback should generally only be that which I think justifies blocking overall approval.
  - For PRs, the test question for overall approval is 'Does the changeset improve the codebase?', and *not* 'Is this perfect?'
...
I attempt to use standard vocabulary in my reviews to make it clear what I expect you to address. From least to most important:
