...
However, almost nobody has a reasonable governance plan to get here. [I read 50+ AI safety plans](https://bluedot.org/blog/ai-safety-paths-plans-and-strategies), and wasn't satisfied with any of them.
...
- 2026-2028: middle powers (UK, EU, EFTA, Canada, Australia, Japan) build leverage in AI, largely through building datacenters. Additionally, duty-based domestic regulation enforces a minimum standard for safe AI development.
...
- If control over AGI is distributed,[^1] any of these actors could [build biological and chemical weapons](https://pmc.ncbi.nlm.nih.gov/articles/PMC9544280/), among many other threats that are hard to build defences for.[^2] With the number of unstable bad actors in the world, someone will inevitably misuse it.
...
The most likely path right now looks like: US companies[^3] continue to develop better AI systems[^4]. As they get closer to AGI and eat more of the economy, the government is forced to nationalize the projects - the political and national security implications are simply too great to leave in the hands of private companies.
...
An AGI-powered totalitarian US government is a very scary prospect. This state could also be durably locked in: unlike a human dictator, an AGI dictator would not naturally die, and is much less vulnerable to physical attacks.
...
Companies like Anthropic race to the top on safety, alongside non-profits and research institutions. This phase:
...
Stable democratic middle powers (like the UK, EU and EFTA members, Canada, Australia, Japan) start building leverage to stay relevant later. The most promising way to do this looks like [building datacenters able to process top secret information](https://adamjones.me/blog/uk-agi-plan-2025/). Other incentives like attracting AI talent[^6], perhaps building trusted institutions (e.g. UK AISI), and maintaining existing alliances with the US are _useful_, but likely insufficient on their own.

Alongside this, duty-based domestic regulation[^7] sets a minimum bar for safety while maintaining an incentive gradient towards ever safer systems. Guidance and enforcement from a competent regulator is crucial here, and there are [many concrete interventions that could be implemented](https://adamjones.me/blog/ai-regulator-toolbox/).

Both of these might be a bit messy in practice, as I expect political lobbying to be intense.[^8]
...
The regulator in the previous stage has acquired a lot of competent technical talent that properly understands AI and has internalised the safety mindset. Additionally, this safety culture and the race to the top dynamic have permeated the AI companies. This all feeds into strong safety foundations in the nationalised project.

At the same time, or soon after, middle power countries reach out with a deal: their leverage in exchange for governance rights over AGI. In practice this will likely focus on access to datacenters that can process top secret information. I expect the US to find this annoying, but ultimately worth it to avoid the risk that China or another authoritarian country gets there first. Countries key to the compute supply chain all get involved, e.g. Taiwan, the Netherlands and South Korea.

You also want [global efforts to avoid a race to the bottom](https://adamjones.me/blog/uk-agi-plan-2025/#avoid-being-in-a-race). This buys more time for technical safety work and governance, especially as international governance moves slowly.

![](../../images/blog/uk-agi-plan-2025/uk-offers-compute-for-governance.png)

### 2029-2030: Global tiered access

Over time, you expand the coalition of countries involved in this international AGI project. Countries joining get some benefits, in exchange for not developing their own AGI systems and restricting AGI development and misuse by actors in their jurisdiction. This shares the benefits of AGI, gives others a say in AGI governance, and reduces the risk that other countries recklessly try to build their own.
...
China is the one country that might be able to lead a competing coalition. But even China might be up for negotiating a deal. China often focuses internally, so it's possible their foreign policy goals don't directly conflict with US interests. At the very least, narrowing it down to two parties makes signing a safety treaty much easier. This treaty could focus on avoiding humanity losing control of AGI completely: a terrible outcome for everyone.

In this phase, the global coalition has bought a lot of headroom - in money, compute, and time - to ensure the necessary safety work can be done. It might also be able to bring about a pause or slowdown in global AI development to buy more time, should that be needed.

We're now set up so that AGI is controlled by a broad coalition with stable democratic countries as core members, already sharing the benefits of AGI. This makes it much less likely that we slide into a totalitarian dystopia, and much more likely that AGI is used as a global public good.

### 2030+: AGI handover, and onto ASI?

It gets harder and harder to predict what happens here. But if we get to this point, I think we're in a much better position than most worlds we seem to be heading for. The below blurs a bit with the previous sections, but hopefully gives a sense of the trajectory.

As capabilities improve, we can trust more and more useful tasks to AI. This includes a fair bit of the safety work, building [the automated alignment researcher](https://www.alignmentforum.org/posts/KwQYsF4XFtPqjgwvH/some-thoughts-on-automating-alignment-research-1). AI might also help us govern it better, for example by designing better institutions, or helping us make better decisions.

On the dangerous side, AI might accelerate AI development through [recursive self-improvement](https://en.wikipedia.org/wiki/Recursive_self-improvement). This could get us to very dangerous systems like superintelligence before the corresponding safety work is in place. Luckily, our robust democratic coalition uses the breathing room it's generated to slow capabilities development and invest more in safety, so this outcome doesn't happen.

Eventually we can ask the AGI (or maybe superintelligence at that point) ["what should we do to get the best outcome"](https://www.lesswrong.com/w/coherent-extrapolated-volition), and it's largely able to figure that out for us. We actually _do_ ask this question, because our coalition of stable democratic countries has resisted sliding into totalitarianism. We've also done the homework first, of course: making sure the system is actually aligned, and that we don't fall into traps like [gradual loss of control](https://gradual-disempowerment.ai/).
