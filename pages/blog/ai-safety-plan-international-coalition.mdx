---
title: "An AI safety plan that might work: an international coalition governing AGI, and how we get there"
...
In this article, I explain why most plans fail, why we're not on track by default - and what a better path looks like.
...
- 2026-2028: middle powers (UK, EU, EFTA, Canada, Australia, Japan) build leverage in AI, largely through building datacenters. alongside, duty-based domestic regulation enforces a minimum standard for safety AI development
...
- 2029-2030: other countries join this coalition, and a safety treaty is made with china, preventing dangerous AGI development and sharing benefits broadly
- 2030+: the coalition governs AGI development into a beneficial future

## Most current plans are bad

Most plans focus on the distribution of AGI capabilities on a spectrum from "widely distributed" to "concentrated in a few hands." But there's no real sweet spot on this spectrum. Both extremes are bad, and everything in between is just a mix of the these problems:

- If control over AGI is distributed,[^1] any of these actors could [build biological and chemical weapons](https://pmc.ncbi.nlm.nih.gov/articles/PMC9544280/), among many other threats that are hard to build defences for.[^2] And inevitably with how many bad and unstable actors there are in the world, someone will use it dangerously.
- If control over AGI is concentrated, we could slide into a [locked-in totalitarian dystopia](https://adamjones.me/blog/ai-oligarchies-arising/). There are [strong incentives](https://intelligence-curse.ai/defining/) and [empricial precedents](https://en.wikipedia.org/wiki/Resource_curse) for this happening.
...
By default, it looks like we're heading towards that locked-in totalitarian dystopia - if humans don't lose control of the technology completely.
...
Both of these might be a bit messy in practice, as I expect political lobbying for many things to be intense during this period.[^8]

### 2028-2029: Nationalisation and forming a democratic coalition

As in the default plan above, US frontier AI companies get closer to AGI. It becomes untennable that this is done in private companies, and the US government nationalises AI development (or at least ['soft nationalises'](https://www.convergenceanalysis.org/publications/soft-nationalization-how-the-us-government-will-control-ai-labs) development, e.g. through managerial, operational or financial control).

The regulator in the previous stage has acquired a lot of competent technical talent that properly understands AI and has internalised the safety mindset. Additionally, this safety culture and the race to the top dynamic has permeated into the AI companies. This all feeds into strong safety foundations in the nationalised project.
...
Additionally, during this period you also want [global efforts to avoid a race to the bottom](https://adamjones.me/blog/uk-agi-plan-2025/#avoid-being-in-a-race). This buys more time for technical safety work and governance, especially as international governance moves slowly.

TODO: trade offer meme
...
- Carrots: access to the benefits of AGI. More trusted countries (or ones with more leverage) might get more access, with tiers like:
    - Full access to inference (running the AGI), governance rights, perhaps own some of the weights[^9]
...
[^3]: All the major AI labs (Anthropic, Google DeepMind, OpenAI) are US-based, and the US has the most compute infrastructure. Even most of the subfrontier labs are US-based (xAI, Meta, Microsoft). There are some China-based and other subfrontier labs (Alibaba, DeepSeek, etc.), which seem to be improving.

[^4]: During this period, I expect many of these increased capabilities are misused by individuals, terror groups and corporations to cause small-to-moderate scale harm. There will be some political fallout, but sadly nothing that fundamentally changes the trajectory of AI development. A lot of discussion during this period will miss the bigger picture, and result in squabbles over short-term fixes and lots of identity politics.
...
- missing things that are are unsafe; and
...
I also expect a lot of general rent-seeking behaviour to emerge during this period, e.g. lobbying by large corporations to entrench their position as they start to see what's coming.
...
Possibly we get this for free if compute is distributed enough, and we expect the coalition having the majority of the compute is enough to maintain control (e.g. analgous to the reasoning behind a [51%](https://www.coinbase.com/en-gb/learn/crypto-glossary/what-is-a-51-percent-attack-and-what-are-the-risks) attack in crypto). But the US does seem likely to have the majority of the compute for a while.
