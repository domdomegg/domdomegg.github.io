...
- In product development, the number one mistake is not [speaking with users](../climb-the-user-contact-ladder/). The number two is talking about your solution instead of their problems - there's [a whole book](https://www.momtestbook.com/) about avoiding it. (Okay, it makes other points too. But that's _the key_ one.)
...
- [Climb the user-contact ladder](../climb-the-user-contact-ladder/): real problems come from real users
