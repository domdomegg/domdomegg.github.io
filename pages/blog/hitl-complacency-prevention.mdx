---
title: "Why AI systems should get more things wrong"
...
There are likely many other things you could do to help with this, and there are many other neglected proposals in AI governance[^4]. Go be a [person who actually does things](https://www.neelnanda.io/blog/become-a-person-who-actually-does-things).
...
[^3]:
     If someone else has come up with this idea, and given it a name [let me know](https://adamjones.me/)! I did try searching online, asking a few AI assistants, and asking a few friends in AI governance and none seemed to have heard of it.

[^4]:
     I’m working on a list of concrete AI governance proposals you could work on, to be published in the next couple of weeks.
